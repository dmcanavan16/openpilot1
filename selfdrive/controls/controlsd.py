...
class Controls:
  def __init__(self, sm=None, pm=None, can_sock=None, CI=None):
    ...
    self.frog_theme = self.params.get_bool("FrogTheme")
    self.frog_sounds = self.frog_theme and self.params.get_bool("FrogSounds")
    self.mute_overheat = self.fire_the_babysitter and self.params.get_bool("MuteSystemOverheat")
