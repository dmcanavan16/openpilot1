...
def get_frogpilot_params():
  ...
  keys = [
    ...
    "ConditionalExperimentalModeStopLights", "ConditionalExperimentalModeCurves", "ConditionalExperimentalModeCurvesLead", "ConditionalExperimentalModeSignal",
    "CustomRoadUI", "LaneLinesWidth", "PathEdgeWidth", "PathWidth", "RoadEdgesWidth", "UnlimitedLength", "DeviceShutdownTimer", "DisableAd", "DisableInternetCheck",
    "ExperimentalModeViaWheel", "FireTheBabysitter", "MuteDM", "MuteDoor", "MuteSeatbelt", "MuteSystemOverheat", "NudgelessLaneChange", "LaneDetection",
    "OneLaneChange", "NumericalTemp", "PersonalTune", "ExperimentalPersonalTune", "RotatingWheel", "Sidebar", "ScreenBrightness", "SteeringWheel", "WideCameraDisable"
  ]
...
def crash_log(candidate):
  ...
  frogpilot_values = [v.decode('utf-8') for v in frogpilot_params.values()]
