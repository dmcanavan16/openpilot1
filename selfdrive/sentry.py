...
try:
  ...
  updated = ""
error_tags = {'dongle_id': dongle_id, 'branch': get_branch(), 'remote': get_origin(), 'fingerprintedAs': candidate}
...
def init(project: SentryProject) -> None:
  ...
  updated = params.get("InstallDate", encoding='utf-8')
  ...
  sentry_sdk.set_user({"updated": updated})
