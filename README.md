...
- Conditional Experimental Mode
  - Automatically enables "Experimental Mode":
    ...
    - When either turn signal is activated below 55mph to help assist with turns
    - When stop signs or stop lights are detected
...
- Numerical temperature gauge to replace the "GOOD", "OK", and "HIGH" temperature statuses
  - Tap the gauge itself to switch between "Celsius" and "Fahrenheit"
